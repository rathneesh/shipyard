...
func CreateBuild(authHeader string, url string, cfg *model.BuildConfig, status *model.BuildStatus, res []*model.BuildResult, testId string, projectId string, runLevel string, action *model.BuildAction) (string, int, error) {
